...
class Order extends Application {
    ...
    function commit($oder_num)
    {
        if(!$this->orders->validate($oder_num))
                redirect('/order/display_menu/' . $oder_num);
            $record = $this->orders->get($oder_num);
    ...
    function cancel($order_num) {
        //FIXME
        $this->orderitems->delete_some($oder_num);
